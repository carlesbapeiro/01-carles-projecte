    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-4 footer">
                ...
                <img class="logo-footer" src="/images/imgHome/img/discord.png" alt="discord">
                <img class="logo-footer" src="/images/imgHome/img/reddit.png" alt="reddit">
